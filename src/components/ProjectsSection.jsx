...
const ProjectsSection = () => {
    ...
    return (
        <section
            id="projects"
            className="min-h-[110vh] bg-[#0a0a0a] text-white font-pixel py-20 px-8 relative overflow-hidden"
        >
            <div className="max-w-7xl mx-auto relative">
                <h2 className="text-4xl text-yellow-300 text-center mb-4">
                    {t('projectsSection.title')}
                </h2>
                <p className="text-gray-400 text-center mb-12 text-sm">
                    Click on projects to explore in detail
                </p>
                                ...
                                <div className="bg-[#16213e] rounded-2xl shadow-2xl shadow-yellow-300/20 border-2 border-yellow-300 w-full max-h-[90vh] overflow-hidden animate-in zoom-in-95 duration-500">
                                    <div className="flex flex-col lg:flex-row h-full max-h-[90vh]">
                                        ...
                                        <div className="lg:w-1/2 relative h-64 sm:h-80 lg:h-auto lg:min-h-[500px]">
                                            ...
                                            <div className="absolute inset-0 bg-gradient-to-br from-yellow-300/30 to-[#00FF88]/30 flex items-center justify-center hidden">
                                                <div className="text-center p-8">
                                                    <div className="w-24 h-24 bg-yellow-300/40 rounded-full flex items-center justify-center mb-6 mx-auto">
                                                        <svg className="w-12 h-12 text-yellow-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                                                        </svg>
                                                    </div>
                                                    <h4 className="text-yellow-300 text-xl font-bold mb-2">{projects[selectedProject].name}</h4>
                                        ...
                                        <div className="lg:w-1/2 p-6 sm:p-8 flex flex-col justify-between overflow-y-auto relative">
                                            ...
                                            <button
                                                ...
                                                className="absolute top-3 right-3 w-8 h-8 bg-[#2a2a2a] hover:bg-[#ff4444] border-2 border-[#555] hover:border-[#ff6666] transition-all duration-200 z-10 pixel-button group flex items-center justify-center"
                                                style={{
                                                    borderRadius: '2px',
                                            ...
                                            >
                                                {/* Simplified centered pixel X */}
                                                <div className="grid grid-cols-3 gap-0 w-3 h-3">
                                                    <div className="w-1 h-1 bg-[#ff6666] group-hover:bg-white"></div>
                                            ...
                                            <div className="space-y-6">
                                                <div>
                                                    <h3 className="text-2xl sm:text-3xl text-yellow-300 font-bold mb-2">
                                                ...
                                                <div>
                                                    <h4 className="text-[#00FF88] text-lg font-semibold mb-4">
                                                        {t('projectsSection.technologiesLabel')}
                                                    </h4>
                                                    <div className="flex flex-wrap gap-2 sm:gap-3">
                                                        {projects[selectedProject].technologies.map((tech, i) => (
                                                            <span
                                                                key={i}
                                                                className="px-3 sm:px-4 py-2 bg-[#00FF88]/20 text-[#00FF88] text-xs sm:text-sm rounded-full border border-[#00FF88]/30 font-medium"
                                                            >
                                                                {tech}
                                                            </span>
                                                        ))}
                                            ...
                                            <div className="pt-6 border-t border-gray-600 mt-6">
                                                <a
                                                    ...
                                                    className="inline-flex items-center gap-2 bg-yellow-300 text-black px-4 sm:px-6 py-3 rounded-lg text-sm sm:text-base font-semibold hover:bg-yellow-400 transition-all duration-300 hover:scale-105"
                                                    target="_blank"
